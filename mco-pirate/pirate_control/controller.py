...
class McoController:
    ...
    def sendEnableVibrato(self, enable):
        opcode = self.EnableVibrato if enable else self.DisableVibrato
        self.interface.send([opcode])
        str =  "Vibrato status:             "
        if enable:  str += "On"
        else:       str += "Off"
    ...
    def sendEnablePwm(self, enable):
        opcode = self.EnablePwm if enable else self.DisablePwm
        self.interface.send([opcode])
        str =  "PWM status:                 "
        if enable:  str += "On"
        else:       str += "Off"
    ...
    def sendEnablePsuNoise(self, enable):
        opcode = self.EnablePsuNoise if enable else self.DisablePsuNoise
        self.interface.send([opcode])
        str =  "PSU status:                 "
        if enable:  str += "On"
        else:       str += "Off"
