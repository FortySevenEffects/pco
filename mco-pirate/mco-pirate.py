...
class McoControlSection(QWidget):
...
class MainWindow(QMainWindow):
    def __init__(self, controller, pirateInterface):
        ...
        self.setWindowTitle("MCO Control Panel")
        self.setFixedSize(windowWidth, windowHeight)
        
        view = McoControlSection(controller, self)
...
mcoController = McoController(pirate)

window = MainWindow(mcoController, pirate)
